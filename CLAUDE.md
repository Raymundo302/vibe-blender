...
- [ ] Video production (script, capture, edit) — plan in Notion "Vibe Coding Blender". Polish ideas: theme-picker toggle-close, M→New Collection single undo, lock-to-view framing distance, proportional default radius, sun shadow maps in Rendered mode, knife tool, parenting, .hdr (RGBE) parsing for World.
