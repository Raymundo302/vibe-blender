...
- [ ] Video production (script, capture, edit) — plan in Notion "Vibe Coding Blender". Polish ideas: lock-to-view framing distance, proportional default radius, sun shadow maps in Rendered mode, HDRI sky for the tracer, knife tool, parenting.
