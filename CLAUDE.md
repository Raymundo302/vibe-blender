...
- [ ] **NEXT: Use & Refine (decided 2026-07-07).** No new features — Ray drives the app for real work and we fix what actually hurts. Feed findings into a running punch list (below + whatever usage surfaces), fix in small verified batches. This dogfooding period doubles as filming practice for the video.
