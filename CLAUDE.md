...
- [ ] Video production (script, capture, edit) — plan in Notion "Vibe Coding Blender". App follow-up ideas: knife tool, parenting hierarchy, edge slide even-mode, UV/texture stretch goal, sun-light shadow maps in Rendered mode, HDRI-style sky for the path tracer.
